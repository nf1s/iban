...
def register_errors(app):
    ...
    @app.exception_handler(IbanDoesNotMatchCountryFormatError)
    def iban_country_format_exception_handler(
        request: Request, exc: IbanDoesNotMatchCountryFormatError
    ):
        return error_response(exc)
